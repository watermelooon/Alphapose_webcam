...
parser.add_argument('--nms', dest='nms_thesh', type=float, default=0.45,
...
parser.add_argument('--mjpg', dest='mjpg_port', type=int,
                    help='mjpg port')
parser.add_argument('--camNO', dest='webcam_num', type=int,
                    help='webcam_num')
